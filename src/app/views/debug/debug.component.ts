...
@Component({
  ...
  template: `
    ...
    <div sfContainerSmall>
      <p>Aenean placerat consectetur urna id vulputate. Curabitur ipsum nunc, bibendum id fringilla et,
        laoreet in nunc. Phasellus erat mi, auctor ultrices iaculis at, iaculis porta quam. Phasellus pulvinar tristique
        nunc non hendrerit. Integer consectetur urna nisl, non viverra turpis malesuada sed. Sed at massa convallis,
        malesuada leo ac, porttitor nisl. Cras fermentum purus sed euismod consectetur. Maecenas quis justo at nunc
        lacinia laoreet quis ut lacus. Phasellus ut ligula lacinia, posuere ex at, pharetra leo. Proin condimentum
        ornare
        interdum. Phasellus auctor nisi in lectus mollis, id euismod mauris scelerisque. Praesent gravida placerat nisi,
        at vulputate quam volutpat quis. In nibh justo, aliquam quis tempus vitae, cursus vel ligula.</p>
    </div>
